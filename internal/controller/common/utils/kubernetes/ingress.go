...
func CreateIngress(ctx context.Context, cli client.Client, svc v12.Service, conf api.ExternalAccess, port string, labels map[string]string) (*networkingv1.Ingress, error) {
